...
@pytest.mark.ai_generated
def test_generate_dandiset_totals_rejects_invalid_cache_directory_type() -> None:
    with pytest.raises(BeartypeCallHintParamViolation):
        dandi_s3_log_extraction.summarize.generate_dandiset_totals(cache_directory=123)
